...
function onLoad() {
    (0, _apiJs.fetchBreeds)("cats").then((resp)=>{
...
function onChange(event) {
    ...
    (0, _apiJs.fetchCatByBreed)(id).then((response)=>{
...
},{"slim-select":"lzHUr","slim-select/dist/slimselect.css":"6O4cs","notiflix":"5z0Oc","./api.js":"8Zgej","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lzHUr":[function(require,module,exports) {
